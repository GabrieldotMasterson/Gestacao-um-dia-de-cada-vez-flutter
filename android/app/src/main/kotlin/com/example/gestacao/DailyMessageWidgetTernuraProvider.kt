...
class DailyMessageWidgetTernuraProvider : AppWidgetProvider() {

    private val TAG = "WidgetTernura"
    ...
    companion object {
        fun updateAppWidget(
            ...
            val TAG = "WidgetTernura"
            Log.d(TAG, "Updating widget $appWidgetId")
            
            val views = RemoteViews(context.packageName, R.layout.widget_ternura_layout)
