...
class DailyMessageWidgetOceanoProvider : AppWidgetProvider() {

    private val TAG = "WidgetOceano"
    ...
    companion object {
        fun updateAppWidget(
            ...
            val TAG = "WidgetOceano"
            Log.d(TAG, "Updating widget $appWidgetId")
            
            val views = RemoteViews(context.packageName, R.layout.widget_oceano_layout)
