...
class DailyMessageWidgetPadraoProvider : AppWidgetProvider() {

    private val TAG = "WidgetPadrao"
    ...
    companion object {
        fun updateAppWidget(
            ...
            val TAG = "WidgetPadrao"
            Log.d(TAG, "Updating widget $appWidgetId")
            
            val views = RemoteViews(context.packageName, R.layout.widget_padrao_layout)
