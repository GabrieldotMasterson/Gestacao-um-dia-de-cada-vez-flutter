...
class DailyMessageWidgetSeuCorpoProvider : AppWidgetProvider() {

    private val TAG = "WidgetSeuCorpo"
    ...
    companion object {
        fun updateAppWidget(
            ...
            val TAG = "WidgetSeuCorpo"
            Log.d(TAG, "Updating widget $appWidgetId")
            
            val views = RemoteViews(context.packageName, R.layout.widget_seucorpo_layout)
