...
class DailyMessageWidgetFloralProvider : AppWidgetProvider() {

    private val TAG = "WidgetFloral"
    ...
    companion object {
        fun updateAppWidget(
            ...
            val TAG = "WidgetFloral"
            Log.d(TAG, "Updating widget $appWidgetId")
            
            val views = RemoteViews(context.packageName, R.layout.widget_floral_layout)
