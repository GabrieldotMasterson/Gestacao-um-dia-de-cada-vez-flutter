...
class DailyMessageWidgetNoiteProvider : AppWidgetProvider() {

    private val TAG = "WidgetNoite"
    ...
    companion object {
        fun updateAppWidget(
            ...
            val views = RemoteViews(context.packageName, R.layout.widget_noite_layout)
