...
class DailyMessageWidgetSerenidadeProvider : AppWidgetProvider() {

    private val TAG = "WidgetSerenidade"
    ...
    companion object {
        fun updateAppWidget(
            ...
            val TAG = "WidgetSerenidade"
            Log.d(TAG, "Updating widget $appWidgetId")
            
            val views = RemoteViews(context.packageName, R.layout.widget_serenidade_layout)
