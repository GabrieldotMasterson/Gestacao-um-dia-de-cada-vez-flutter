...
class DailyMessageWidgetTransformacaoProvider : AppWidgetProvider() {

    private val TAG = "WidgetTransformacao"
    ...
    companion object {
        fun updateAppWidget(
            ...
            val TAG = "WidgetTransformacao"
            Log.d(TAG, "Updating widget $appWidgetId")
            
            val views = RemoteViews(context.packageName, R.layout.widget_transformacao_layout)
